...
import { View, StyleSheet, TouchableOpacity, Vibration, Alert } from 'react-native';
import { Text, IconButton } from 'react-native-paper';

import { IContact, IGood, IMGoodData, IMGoodRemain, IRem, IRemains, IRemainsData, IWeightCodeSettings } from '../../../../../../common/base';
              ...
              <View style={localStyles.buttonsContainer}>
                ...
                >
                  ...
                  <View style={localStyles.goodInfo}>
                    ...
                    <Text style={localStyles.barcode}>{goodItem?.good.barcode}</Text> */}
                  </View>
                </TouchableOpacity>
              </View>
            )}
