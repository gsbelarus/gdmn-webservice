...
import { IDevice, IActivationCode, IUser } from '../models/models';
import { readFile, writeFile } from '../utils/workWithFile';
import { PATH_LOCAL_DB_DEVICES, PATH_LOCAL_DB_ACTIVATION_CODES, PATH_LOCAL_DB_USERS } from '../server';
...
export { newDevice, getDevice, getUsersByCompany, editeDevice, removeDevice };
